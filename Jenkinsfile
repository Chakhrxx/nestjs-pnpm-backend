    ...
    stage('SSH Tranfers') {
      steps {
        ...
        publishers: [
            ...
            transfers: [
                sshTransfer(
                sourceFiles: 'config/, dist/, middlewares/, models/, routes/, src/ , Ansiblefile.yaml, Dockerfile, nest-cli.json, package.json, pnpm-lock.yaml, tsconfig.build.json, tsconfig.json',
